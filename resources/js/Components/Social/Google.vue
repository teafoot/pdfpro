...
<template>
    <a
        ...
        class="mb-2 flex rounded px-6 py-2.5 text-xs font-medium uppercase leading-normal text-grey border shadow-md transition duration-150 ease-in-out hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg">
